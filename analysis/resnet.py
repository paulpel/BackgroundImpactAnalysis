...
def compare_images_and_save_results(original_dir, modified_dir, model, device, transform, output_csv_path):
    results = []
...
compare_images_and_save_results(original_images_dir, removed_bg_images_dir, model, device, transform, output_csv)
